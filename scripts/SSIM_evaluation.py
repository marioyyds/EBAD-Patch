...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='/data/hdd3/duhao/code/EBAD/data/CVPR_Adversarial/', type=str)
    parser.add_argument('-dirB', default='/data/hdd3/duhao/ssim_eps_10_ceshi/advs/', type=str)
    # parser.add_argument('-dirB', default='/data/hdd3/duhao/code/EBAD/data/CVPR_Adversarial/', type=str)
